...
const imgElement = makeImg(imgObj);
...
// destructure is to take apart


import dataPanel from './data/panelData';
import linkD from './data/linkData'
...
// console.log(dataPanel) // log the panelData
// console.log(linkD);

// console.log(constant) // log the open arrow
...
const panelEle = dataPanel.map(panelObj => {
  return makePanel(panelObj);
})
// console.log(panelEle);

panelEle.forEach(panelEle => {
  accordion.appendChild(panelEle);
})
